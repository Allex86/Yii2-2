...
-- Дамп данных таблицы yii2advanced.project: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `project` DISABLE KEYS */;
INSERT INTO `project` (`id`, `title`, `description`, `active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(1, 'Project', 'Project', 1, 1, 1, 1536571181, 1536571181),
	(2, 'Project 2', 'Project 2', 1, 2, 2, 1536574128, 1536574128);
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `avatar`, `created_at`, `updated_at`) VALUES
	(1, 'Username1', 'ZY6O5Amd08eL7qFdbjHjMa1SyKXKpMIg', '$2y$13$HMLO0IgtF0PaTh8pRJ1MXOkyYH4X/vPsCtw4M3ASemptDYDQQkeQO', NULL, 'Username@mail.ru', 10, '5b8f7efbb0d7e.jpg', 1534950662, 1536559730),
	...
	(5, 'Username5', '4vcBGmqvGAelh03Ws6KUabBDXx6KQG9Q', '$2y$13$UavLrbxP43m0xWIr9xRWe.lXdVOTWU8UIQ/33livr2kiouxodcUhm', NULL, 'Username5@link.com', 10, NULL, 1536546846, 1536546846);
