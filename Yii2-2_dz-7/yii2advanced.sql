...
INSERT INTO `project` (`id`, `title`, `description`, `active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(1, 'Project', 'Project', 1, 1, 1, 1536571181, 1536738958),
	(2, 'Project 2', 'Project 2', 1, 2, 1, 1536574128, 1536735559),
	(3, 'Project 3', 'Project 3', 1, 1, 1, 1536668057, 1536668132);
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `avatar`, `created_at`, `updated_at`) VALUES
	(1, 'Username1', 'ZY6O5Amd08eL7qFdbjHjMa1SyKXKpMIg', '$2y$13$5jm7FayQcdouGV.drH.wB.wqBeGQOPggSz/QPh0./vBDrLx848UNm', NULL, 'Username@1.1', 10, '5b8f7efbb0d7e.jpg', 1534950662, 1536735064),
	...
	(5, 'Username5', '4vcBGmqvGAelh03Ws6KUabBDXx6KQG9Q', '$2y$13$O2hUdzYR8kulD/6Oc1CyDuA/XFfyO6/E.WaTSjDt0f21DU1V/2GIe', NULL, 'Username5@5.5', 10, NULL, 1536546846, 1536735147);
